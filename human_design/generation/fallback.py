...
EXPLORE_ENTRIES: tuple[tuple[str, str, str], ...] = (
    ("talent", "天赋", "看哪些能力像天然会的，又该怎样练成稳定贡献。"),
    ("mission", "使命", "看人生主轴怎样通过角色、选择和长期行动活出来。"),
