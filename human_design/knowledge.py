...
AUTHORITY_GUIDES = {
    ...
    "sacral": "荐骨权威要用身体的即时回应来判断：嗯/不是、扩张/收缩、想靠近/想离开。越接近身体，越接近正确。",
    "splenic": "脾权威是安静、瞬时、一次性的直觉信号。它来得很快，不一定会重复，所以需要学会识别当下那一下真实感。",
    "ego-manifested": "意志权威要先问自己：我真想不想？我愿不愿意为这件事投入意志与承诺？不是该不该，而是我到底要不要。",
    "ego-projected": "Ego Projected Authority 需要在被看见的关系里说出来：听见自己是否真的想为这件事投入意志与承诺。它不同于 Self-Projected Authority，不是用身份方向感作决定。",
...
DEFINITION_GUIDES = {
    "no": "无定义常见于反映者，整体更受环境影响，作决定时更要重视空间与时间。",
    "single": "一分人的内部线路连在一起，很多事情可以先在自己这里消化，再形成清晰。",
    "simple-split": "二分人的稳定能量分成两块，有些人和互动会带来突然被接通的感觉。",
    "wide-split": "二分人的两块稳定能量距离较远，不必逼自己马上整合，给过程多一点时间更合适。",
    "triple-split": "三分人需要移动、不同的人和不同场域，帮助内部信息慢慢流通起来。",
    "quadruple-split": "四分人的内部整合很需要环境流动和时间，不适合在封闭压力里匆忙作结论。",
}
...
CENTER_GUIDES = {
    ...
    "ajna": {
        "label": "阿姬娜中心",
        "defined": "定义阿姬娜中心会让思考方式和认知结构较稳定，适合形成自己的分析框架。",
        "undefined": "开放阿姬娜中心说明你思路更灵活，但也容易想把一切想确定。真正的成熟是允许自己不急着定论。",
    },
    "throat": {
        "label": "喉中心",
    ...
    "sacral": {
        "label": "荐骨中心",
        "defined": "定义荐骨中心带来稳定生命力。真正的关键不是多忙，而是忙在正确回应上。",
        "undefined": "开放荐骨中心说明你不是持续输出型。节奏、休息和边界不是奢侈品，而是核心配置。",
    },
    "root": {
        "label": "根中心",
