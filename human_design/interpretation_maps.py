...
MAP_TITLES = {
    "body": ("身体报告", "了解你怎样做决定、怎样使用能量，以及压力来了以后怎样回到自己的节奏。"),
    "channels": ("通道报告", "了解每条通道带来的能力，以及这些能力怎样在真实生活里一起工作。"),
    "wealth": ("财富报告", "了解你怎样创造价值、哪些能力可以形成收入，以及什么承诺最容易让你白忙。"),
    "talent": ("天赋报告", "了解你天然会什么、为什么容易忽视它，以及怎样把已有的能力练成代表作。"),
    "relationship": ("关系报告", "了解你怎样靠近一个人、最容易在哪些地方失去自己，以及什么相处方式更适合你。"),
    "mission": ("人生方向报告", "了解你反复遇到的人生主题，以及它怎样通过真实能力和日常选择慢慢活出来。"),
